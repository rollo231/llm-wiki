...
- [[AI DE course as a DE curriculum]] — ⭐⭐ **강의 목차를 커리큘럼으로 평가한다.** *"만들 수 있는
  DE"가 아니라 "판단할 수 있는 DE"* 를 만든다 — 실습 0 · 도구 챕터 8p · AI 특화 55%.
  목차에 통째로 없는 축 5종 · 코스 내부 모순 4건 · **⭐⭐ 이상만 349p(전체의 30%)** 인 배분표.
