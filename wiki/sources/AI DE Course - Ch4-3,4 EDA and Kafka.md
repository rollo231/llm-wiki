...
created: 2026-08-01
updated: 2026-08-01
sources: ["raw/data-engineering/CH04-3, 4. 이벤트 기반 아키텍처(EDA)와 Kafka의 핵심 개념 (Topic, Partition, Offset) 1, 2.pdf"]
---
...
`raw/data-engineering/CH04-3, 4. 이벤트 기반 아키텍처(EDA)와 Kafka의 핵심 개념 (Topic, Partition, Offset) 1, 2.pdf`
